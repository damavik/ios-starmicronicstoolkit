...
//  [builder appendSpecifiedPosition:1 y:1];
    ...
    switch (number) {
        default : image = [UIImage imageNamed:@"DisplayImage1.png"]; break;     // 0
        case 1  : image = [UIImage imageNamed:@"DisplayImage2.png"]; break;
        case 2  : image = [UIImage imageNamed:@"DisplayImage3.png"]; break;
        case 3  : image = [UIImage imageNamed:@"DisplayImage4.png"]; break;
    }
