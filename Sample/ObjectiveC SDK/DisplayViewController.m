...
//          case 1  :     // Text
                ...
                [DisplayFunctions appendTextPattern:builder number:(int) (buttonIndex - 1)];
                break;
            case 2 :     // Graphic
                [DisplayFunctions appendClearScreen:builder];
                
                [DisplayFunctions appendGraphicPattern:builder number:(int) (buttonIndex - 1)];
                break;
            case 3 :     // Turn On / Off
//              [DisplayFunctions appendClearScreen:builder];
            ...
            case 4 :     // Cursor
                ...
                [DisplayFunctions appendCursorMode:builder cursorMode:buttonIndex - 1];
                break;
            case 5 :     // Contrast
//              [DisplayFunctions appendClearScreen:builder];
                
                [DisplayFunctions appendContrastMode:builder contrastMode:buttonIndex - 1];
                break;
