...
//          }
            ...
            NSDate *startSendDataDate = [NSDate date];
            ...
            while (total < data.length) {
                ...
                if ([[NSDate date] timeIntervalSinceDate:startSendDataDate] >= 30.0) {     // 30000mS!!!
                    break;
                }
            }
            ...
            while (result == NO) {
                if ([[NSDate date] timeIntervalSinceDate:startSendDataDate] >= 0.25) {     // 250mS!!!
                    break;
                }
                
                [NSThread sleepForTimeInterval:0.05];       // 50mS Break Time
