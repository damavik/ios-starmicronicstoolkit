...
class BlackMarkPasteViewController: CommonViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let doneButton: UIBarButtonItem = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.done, target: self, action: #selector(BlackMarkPasteViewController.closeKeyboard(textView:)))
